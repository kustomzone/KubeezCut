  ...
  const exportActions: DebugAction[] = [
    {
      ...
      action: () => runAction(handleExportJson, 'Downloaded .kubeez.json'),
                  ...
                  <div className="space-y-0.5">
                    <Button
                      ...
                      className={cn(
                        ...
                        showVideoDebugOverlay && "bg-primary/20 text-primary"
                      )}
                    ...
                    >
                      ...
                      {showVideoDebugOverlay && (
                        <span className="ml-auto text-[10px] bg-primary/30 px-1.5 py-0.5 rounded">ON</span>
                      )}
                    </Button>
                  </div>
                </div>
