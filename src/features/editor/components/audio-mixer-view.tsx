...
// ---------------------------------------------------------------------------
// Smooth level meter (shared between channel strips & bus)
// ---------------------------------------------------------------------------
  ...
  return (
    <div className={`relative flex-1 rounded-[2px] bg-[#08090b] overflow-hidden ${className}`}>
      ...
      <div
        ref={fillRef}
        {...fillProps}
        className={`absolute inset-x-0 bottom-0 rounded-[1px] bg-gradient-to-t from-[#1be255] via-[#f5e146] to-[#ff6633] ${scanning ? 'opacity-50' : ''}`}
        style={{
          height,
      ...
      {peakBottom != null && (
        <div
          className="absolute inset-x-0 h-0.5 rounded-sm bg-white/90 shadow-[0_0_6px_rgba(255,255,255,0.45)]"
          style={{
            bottom: peakBottom,
          ...
          <div className="flex gap-[2px] w-[14px] shrink-0">
            <div className="relative flex-1 rounded-[2px] bg-[#08090b] overflow-hidden">
              ...
              <div
                ...
                className={`absolute inset-x-0 bottom-0 rounded-[1px] bg-gradient-to-t from-[#1be255] via-[#f5e146] to-[#ff6633] ${showScanningFallback ? 'opacity-50' : ''}`}
                style={{
                  height: '0%',
                  transition: 'height 100ms ease-out',
                }}
